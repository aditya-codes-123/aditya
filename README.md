...
<head>
    ...
    <title>Aditya Adhikari - Interactive Resume</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&family=Lato&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        :root {
            --primary-color: #f0f0f0;  /* Brighter text for better contrast */
            --accent-color: #7C4DFF;    /* Slightly adjusted purple */
            --background-color: #121212; /* True dark background */
            --card-bg: #1E1E1E;         /* Material Dark surface color */
        }
